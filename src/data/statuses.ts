...
export const STATUSES: Record<string, StatusMeta> = Object.fromEntries(
  [
    ...
    // class resources & powers (7 newer classes)
    S('fury', 'resource', 'fang', '#ff6a3d', L('Öfke', 'Fury'), L('Öfke harcayan saldırıları güçlendirir.', 'Fuels attacks that spend Fury.')),
    S('bearForm', 'power', 'bear', '#a0703d', L('Ayı Formu', 'Bear Form'), L('Tur başında {n} blok kazan.', 'At the start of your turn, gain {n} Block.')),
    S('wolfForm', 'power', 'wolf', '#9aa0a8', L('Kurt Formu', 'Wolf Form'), L('Her tur +1 hareket, saldırılar +2 hasar.', '+1 movement each turn, attacks deal +2 damage.')),
    S('owlForm', 'power', 'eye', '#c9a0ff', L('Baykuş Formu', 'Owl Form'), L('Her tur 1 fazla kart çek.', 'Draw 1 extra card each turn.')),
    S('feral', 'power', 'claw', '#8bbf3a', L('Yabani İçgüdü', 'Feral Instinct'), L('Form değiştirdiğinde {n} enerji kazan.', 'Whenever you change form, gain {n} energy.')),
    S('primal', 'power', 'claw', '#e0533d', L('İlkel Öfke', 'Primal Fury'), L('Bir formdayken saldırıların {n}×3 fazla hasar verir.', 'While in a form, attacks deal {n}×3 more damage.')),
    S('runeFire', 'resource', 'rune', '#ff8a2a', L('Ateş Rünü', 'Fire Rune'), L('Saldırıların {n} fazla hasar verir.', 'Your attacks deal {n} more damage.')),
    S('runeFrost', 'resource', 'rune', '#8fe3ff', L('Buz Rünü', 'Frost Rune'), L('Tur sonunda {n}×2 blok kazan.', 'At the end of your turn, gain {n}×2 Block.')),
    S('runeStorm', 'resource', 'rune', '#ffe066', L('Fırtına Rünü', 'Storm Rune'), L('Tur sonunda rastgele düşmana {n}×2 hasar ver.', 'At the end of your turn, deal {n}×2 damage to a random enemy.')),
    S('runeAmp', 'power', 'rune', '#e05aa8', L('Rün Ustalığı', 'Runic Mastery'), L('Rün etkileri {n} kat daha güçlü.', 'Rune effects are {n}x stronger.')),
    S('runeGen', 'power', 'rune', '#e05aa8', L('Dünya Rünü', 'World Rune'), L('Tur başında {n} rastgele rün kazan.', 'At the start of your turn, gain {n} random rune(s).')),
    S('runeCap', 'power', 'rune', '#b38cff', L('Derin Oyma', 'Deep Carving'), L('Her rünün üst sınırı {n} artar.', 'Each rune type can hold {n} more.')),
    S('vigil', 'buff', 'spear', '#c3c8d4', L('Nöbet', 'Vigil'), L('Tur sonunda bitişik düşmanlara {n} hasar ver.', 'At the end of your turn, deal {n} damage to adjacent enemies.')),
    S('bastion', 'power', 'wall', '#9aa7b8', L('Kırılmaz Sur', 'Unbreakable Wall'), L('Blok turlar arasında sıfırlanmaz.', 'Block is no longer removed between turns.')),
    S('doom', 'debuff', 'skull', '#ff4d7a', L('Kıyamet', 'Doom'), L('Kıyamet, canına ulaşınca ölür. ({n})', 'Dies when Doom reaches its HP. ({n})')),
    S('doomAura', 'power', 'skull', '#b8325e', L('Boşluk Ayini', 'Void Rite'), L('Tur başında tüm düşmanlara {n} Kıyamet uygula.', 'At the start of your turn, apply {n} Doom to all enemies.')),
    S('painDraw', 'power', 'blood', '#b8325e', L('Çarpık Pakt', 'Twisted Pact'), L('Kendi turunda can kaybettiğinde {n} kart çek.', 'Whenever you lose HP on your turn, draw {n} card(s).')),
    S('eldritch', 'power', 'tentacle', '#b8325e', L('Kadim Uyanış', 'Old One Wakes'), L('Tur sonunda 1 can kaybet ve tüm düşmanlara {n}×6 hasar ver.', 'At the end of your turn, lose 1 HP and deal {n}×6 damage to all enemies.')),
    S('stormcall', 'power', 'lightning', '#34c3e0', L('Fırtına Çağıran', 'Storm Caller'), L('Tur sonunda rastgele düşmana 6 hasar ver ({n} kez).', 'At the end of your turn, deal 6 damage to a random enemy ({n}x).')),
    S('totemEcho', 'power', 'totem', '#34c3e0', L('Element Öfkesi', 'Elemental Fury'), L('Totemler her tur {n} kez fazla titreşir.', 'Totems pulse {n} more time(s) each turn.')),
    S('furyGen', 'power', 'fang', '#ff6a3d', L('Durdurulamaz', 'Unstoppable'), L('Tur başında {n} Öfke kazan.', 'At the start of your turn, gain {n} Fury.')),
    S('hoard', 'power', 'coin', '#ffd35a', L('Kaptanın Hazinesi', "Captain's Hoard"), L('Tur başında {n} altın kazan.', 'At the start of your turn, gain {n} gold.')),
