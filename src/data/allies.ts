...
export const ALLIES: Record<string, AllyDef> = {
  skeleton: { id: 'skeleton', name: L('İskelet', 'Skeleton'), sprite: 'skeleton', palette: { a: '#e8e2cf', b: '#b9b09a' }, hp: 8, hpUp: 4, speed: 1, dmg: 4, range: 1 },
  ...
  turret: { id: 'turret', name: L('Taret', 'Turret'), sprite: 'turret', hp: 10, hpUp: 4, speed: 0, dmg: 4, range: 4 },
